-- Seed data for Decrypt Night competition
...
-- This is just a placeholder - you'll need to manually update the role after user registration
-- INSERT INTO profiles (id, full_name, email, role) VALUES 
-- ('your-admin-user-id-here', 'Admin User', 'admin@psu.edu', 'admin');

-- You can also create test users for development
-- INSERT INTO profiles (id, full_name, email, role) VALUES 
-- ('test-user-1', 'Test User 1', 'test1@psu.edu', 'player'),
-- ('test-user-2', 'Test User 2', 'test2@psu.edu', 'player');